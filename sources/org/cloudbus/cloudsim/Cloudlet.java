...
public class Cloudlet {
	...
	private long cloudlet_deadline = 0; //deadline
	private double startTime = 0.0; //starttime
	private double violationCost = 0.0;
	// Data cloudlet
	/** The required files. */
	...
	public void violationCostInc(double a, long b) {
		violationCost += Math.abs(a-b);
	}
